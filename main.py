# ==========================================
# Project: מתווך בקליק | Version: 1215-G2
# ==========================================
...
def fetch_q_ai(topic):
    try:
        ...
        # פיצול שורות למניעת חיתוך ב-GitHub
...
if st.session_state.step == "login":
        ...
        if st.session_state.lesson_txt not in ["", "LOADING"]:
            if st.session_state.quiz_finished:
                if st.button("📝 נסה שאלון חדש בנושא"):
                    st.session_state.update({
                        "quiz_finished": False, "quiz_active": False, "q_count": 0
                    })
                    st.rerun()
                    ...
                    with st.spinner("מעלה שאלה..."):
                        ...
                        if res:
                            st.session_state.update({
                                ...
                                "show_ans": False, "correct_answers": 0
                            })
                            st.rerun()
    ...
    st.markdown(
        f'<div class="v-footer">Version: 1215-G2</div>', 
        unsafe_allow_html=True
    )
