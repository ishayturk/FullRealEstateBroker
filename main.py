...
# Version: V137 | Date: 23/02/2026 | 11:15
...
st.markdown("""
    ...
    * { direction: rtl; text-align: right; }
    ...
    /* --- 3. מגזר נייד (Mobile - Clean) --- */
    @media (max-width: 768px) {
        /* ביטול מבנה העמודות של Streamlit והפיכתו לרציף */
        div[data-testid="stHorizontalBlock"] {
            display: block !important;
        }
        
        /* העלמה מוחלטת של הטור הראשון (ניווט ושעון) */
        div[data-testid="column"]:nth-of-type(1) {
